...
static void GetSharedFunctionInfoBytecode(MacroAssembler* masm,
    ...
    __ movp(sfi_data, FieldOperand(sfi_data, InterpreterData::kBytecodeArrayOffset));
...
void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm) {
  ...
  GetSharedFunctionInfoBytecode(masm, kInterpreterBytecodeArrayRegister, kScratchRegister);
